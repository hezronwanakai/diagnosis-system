        ...
        <div class="col-md-8">
            ...
            <?php foreach (!empty($allComments) ? $allComments : [] as $cmt): ?>
                <div class="card p-3 bg-dark text-white mb-2">
                    ...
                    <small><?=($cmt->userId == (isset($_SESSION['us3rid']) ? $_SESSION['us3rid'] : null)) ? 'Self' : (is_object($user->getExpertInfo($cmt->userId)) ? "Dr. " . $user->getExpertInfo($cmt->userId)->name : 'Unknown Expert');?> ~ <span class="text-info"><em>On: <?=date_to_text($cmt->created_at);?></em></span></small>
